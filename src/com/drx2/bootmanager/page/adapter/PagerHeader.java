...
public class PagerHeader extends ViewGroup {
    ...
    public PagerHeader(Context context, AttributeSet attrs) {
        ...
        colors = context.getSharedPreferences(PREFS_DEVICE, 0);
        
        // Get attributes from the layout xml
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PagerHeader, 0, 0);
        mActiveTextColor = new ColorSet(a.getColor(R.styleable.PagerHeader_activeTextColor, colors.getInt("pageTitleText", getResources().getColor(R.color.vpTitle))));
        mInactiveTextColor = new ColorSet(a.getColor(R.styleable.PagerHeader_inactiveTextColor, colors.getInt("pageUnusedTitleText", getResources().getColor(R.color.vpTitleUnused))));
        mTabColor = new ColorSet(a.getColor(R.styleable.PagerHeader_tabColor, mActiveTextColor.getColor()));
        ...
        mFadingEdgeLength = a.getDimensionPixelSize(R.styleable.PagerHeader_fadingEdgeLength, dipToPixels(30));
        ...
        mShadow = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[] {0x88000000, 0x00000000});
